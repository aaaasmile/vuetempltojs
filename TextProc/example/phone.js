// this is only test code. Not a valid component at all. Interesting is only the template section.
export const phone = new Vue({
  el: '#app',
  vuetify: new Vuetify(),
  data: {
      Buildnr: "0.1"
...
console.log('Phone is here!', window.buildnr)
